...
# Передача прав владения директорией /app пользователю django
# Это необходимо для создания поддиректорий после переключения на непривилегированного пользователя
